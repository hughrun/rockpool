...
// TODO: make a function checking for *include* tags to address Issue #68
      ...
      .then( res => {
        if (res.users.length > 0) {
          ...
          for (let user of res.users) {
            ...
            let excluded = user.pocket.excluded.some( x => x.equals(data.id))
            if (!excluded) {
              ...
              .catch(err => {
                ...
                console.error('ERROR at feeds.js line 93')
            ...
            if (items) {
              items.forEach( function (item) {
                ...
                if (downcased.some(excluded)) {
                  ...
                  // TODO: this is where we can address Issue #68
