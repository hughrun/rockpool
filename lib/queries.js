...
const deleteBlogs = function(ids) { // ids is an object from the checked boxes
	return new Promise( function (resolve, reject) {
      ...
      const deleteDocs = function(db, callback) {
        ...
        const array = Object.keys(ids) // the keys are the blog ids and the values just say 'on'
        // TODO: currently ids are strings but after full migration will need to be converted to ObjectIds
